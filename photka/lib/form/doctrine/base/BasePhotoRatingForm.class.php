...
/**
 * PhotoRating form base class.
 *
 * @method PhotoRating getObject() Returns the current form's model object
 *
 * @package    photka
 * @subpackage form
 ...
 */
abstract class BasePhotoRatingForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('photo_rating[%s]');
